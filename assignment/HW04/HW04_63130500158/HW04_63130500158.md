...
5 Seattle                 426
```
**Explain ->** เมือง New York City เป็นเมืองที่มีการสั่งสินค้าเป็นอันดับที่ เมือง Los Angeles เป็นอันดับที่ 2 เมือง Philadelphia เป็นอันดับที่ 3 เมือง San Francisco เป็นอันดับที่ 4 เมือง Seattle เป็นอันดับที่ 5
...
# A tibble: 3 x 3
  Category           max   min
  <chr>            <dbl> <dbl>
1 Furniture        4416. 1.89 
2 Office Supplies  9893. 0.444
3 Technology      22638. 0.99 
```
**Explain ->** อธิบาย

### 5.) หาค่าเฉลี่ยค่าใช้จ่ายของคนที่ใช้จ่ายต่อ 1 สินค้ามากที่สุด
```R
