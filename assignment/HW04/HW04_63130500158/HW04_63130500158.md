...
**Created by Name-Surname (ID: 63130500158)**
...
# ... with 25 more rows
```
**Explain ->** มีสินค้าที่อยู่ในรัฐ Colorado และมีประเภท Technology ทั้งหมด 35 รายการ ตามผลลัพธ์ด้านบน
...
```
**Explain ->** มีสินค้าทั้งหมด 7 รายการที่่ถูกสั่งเมื่อวันที่ 14 กุมภาพันธ์ 2016 และ มี 1 รายการที่่ถูกสั่งเมื่อวันที่ 13 เมษายน 2017 ตามผลลัพธ์ด้านบน
...
5 Seattle                 426
```
**Explain ->** เมือง New York City เป็นเมืองที่มีการสั่งสินค้าเป็นอันดับที่ เมือง Los Angeles เป็นอันดับที่ 2 เมือง Philadelphia เป็นอันดับที่ 3 เมือง San Francisco เป็นอันดับที่ 4 และ เมือง Seattle เป็นอันดับที่ 5 ตามผลลัพธ์ด้านบน
...
```
**Explain ->** ประเภท Furniture มีสิ่งที่ราคาถูกที่สุดคือ 1.89 และแพงที่สุดคือ 4416.174 ประเภท Office Supplies มีสิ่งที่ราคาถูกที่สุดคือ 0.444 และแพงที่สุดคือ 9893 และประเภท Technology มีสิ่งที่ราคาถูกที่สุดคือ 0.99 และแพงที่สุดคือ 22638 (ที่ max ไม่มีทศนิยมเพราะโปรแกรมปัดให้แล้วซึ่ง 0-4 ปัดลง 5-9 ปัดขึ้น)
...
1         1670.
```
**Explain ->** หาคนที่ใช้จ่ายสินค้าต่อ 1 สินค้ามากที่สุดตาม Article5.1 โดยชื่อที่ได้มาก็คือ Sean Miller แล้วหลังจากนั้นจึงมาหา mean ใน Article5.1 โดยมีค่าเฉลี่ยคือ 1670 (ที่ mean(Sales) ไม่มีทศนิยมเพราะโปรแกรมปัดให้แล้วซึ่ง 0-4 ปัดลง 5-9 ปัดขึ้น)
...
```
**Explain ->** จะได้ว่า Zuschuss Carroll ได้รับการจัดส่งแบบ Standard Class 26 ครั้งเป็นอันดับที่ 1 
...
### 2.) กราฟแสดงจำนวนคนที่ซื้อสินค้าราคามากกว่า 5000 ในแต่ละภูมิภาค
```
Graph2 <- Superstore %>% 
  group_by(Region) %>% 
...
**Summary**
จากกราฟมีคนที่ซื้อของราคามากกว่า 5000 จำนวน 19 คน แบ่งออกเป็นภูมิภาค Central 5 คน 
East 7 คน South 4 คน  West 3 คน
